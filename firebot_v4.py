"""
firebot_v4.py — Fire-detection bot with staggered extinguisher trigger

Drives forward continuously.
Fire detected → stops immediately.
Fire seen for 1.3s → servo 1 fires.
Fire seen for 2.0s → servo 1 detaches, servo 2 fires.
Auto-reconnects if Arduino resets.

Arduino sketch: pbot_v4.ino

Usage:
    python firebot_v4.py
"""
