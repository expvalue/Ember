"""
firebot_v3.py — Fire-detection bot with staggered extinguisher trigger
...
Survives Arduino resets / servo power spikes — auto-reconnects.

Arduino sketch: pbot_v3.ino

Usage:
    python firebot_v3.py
"""
